 ...
 * 
 * import java.util.Collection; import java.util.List; import java.util.Objects;
 ...
 * 
 * import com.bezkoder.spring.jwt.mongodb.models.User; import
 ...
 * 
 * public static UserDetailsImpl build(User user) { List<GrantedAuthority>
 * authorities = user.getRoles().stream() .map(role -> new
